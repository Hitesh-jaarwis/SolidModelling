...
//  ClassCode27
//
//  Created by Hitesh Arora on 7/27/16.
...
const char faceColors [6][3] = {{  0, static_cast<char>(255),   0},  // front wall = green
    {  0, static_cast<char>(255),   0},  // back wall = green
    {static_cast<char>(255),   0,   0},  // left wall = red
    {static_cast<char>(255),   0,   0},  // right wall = red
    {  0,   0, static_cast<char>(255)},  // ceiling = blue
    {  0,   0, static_cast<char>(255)}}; // floor = blue
...
void setUpSyntheticCamera (SyntheticCamera& synCam)
{
    ...
    double vpn [3]; // from camera to pt being looked at (0, 5, 0); View plane Normal
